...
/**
 * @ClassName CustomerSocketTextStreamFunction
 * @Description 创建CustomerSocketTextStreamFunction从serverSocket读取文本并转换为JSON
 * @Author ml.c
    ...
    public void run(SourceContext<Row> ctx) throws Exception {
        ...
        while (isRunning) {
            try {
                ...
                LOG.info("Connection server failed, Please check configuration  !!!!!!!!!!!!!!!!"+e.getMessage());
            }
